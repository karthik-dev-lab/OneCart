...
function Login() {
  ...
  // ← ADD THIS: auto-fill credentials
  const fillCredentials = () => {
    setEmail("admin@onecart.com")
    setPassword("admin1234567")
  }

  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
      <div className='w-[100%] h-[80px] flex items-center justify-between px-[30px] gap-[10px]'>
        ...
        {/* ← ADD THIS: Admin credentials card top right */}
        <div 
          onClick={fillCredentials}
          className='bg-[#ffffff10] border border-[#ffffff25] rounded-lg px-[15px] py-[8px] cursor-pointer hover:bg-[#ffffff20] transition-all'
          title="Click to auto-fill"
        >
          <p className='text-[11px] text-[#ffffff80] mb-[2px]'>Admin Credentials</p>
          <p className='text-[12px] text-[#ffffffc0]'>📧 admin@onecart.com</p>
          <p className='text-[12px] text-[#ffffffc0]'>🔑 admin1234567</p>
          <p className='text-[10px] text-[#6060f5] mt-[2px]'>Click to auto-fill ↗</p>
        </div>
